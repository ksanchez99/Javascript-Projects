...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = 'O';
            //if active player is anything other 'X'
        } else {
...
function checkWinConditions() {
    ...
    // X 0, 7, 8 condition.
    else if (arrayIncludes('0X', '7X', '8X')) { drawWinLine(100, 100, 520, 520) }
    // O 0, 1, 2 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    y1 = coordY1,
    //This line indicates where the end of a lines x axsis is.
    x2 = coordX2,
    //This line indicates where the end of a lines y axsis is.
    y2 = coordY2,
    ...
    function animateLineDrawing() {
        ...
        c.stroke();
        //This condition checks if we've reasched ther endpoints.
        if (x1 <= x2 && y1 <= y2) {
            ...
            //this is neccessary for the 6, 4, 2 win coinditions.
